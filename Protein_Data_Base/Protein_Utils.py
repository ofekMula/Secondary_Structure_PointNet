...
residue_to_attributes = {'C' : np.array([28,7.4,26.3,40.3,7.4,0]),'D' : np.array([28,7.4,26.3,40.3,7.4,0]),
                         'S' : np.array([28,7.4,26.3,40.3,7.4,0]),'Q' : np.array([28,7.4,26.3,40.3,7.4,0]),
                         'K' : np.array([28,7.4,26.3,40.3,7.4,0]),'I' : np.array([28,7.4,26.3,40.3,7.4,0]),
                         'P' : np.array([28,7.4,26.3,40.3,7.4,0]),'T' : np.array([28,7.4,26.3,40.3,7.4,0]),
                         'F' : np.array([28,7.4,26.3,40.3,7.4,0]),'N' : np.array([28,7.4,26.3,40.3,7.4,0]),
                         'G' : np.array([28,7.4,26.3,40.3,7.4,0]),'H' : np.array([28,7.4,26.3,40.3,7.4,0]),
                         'L' : np.array([28,7.4,26.3,40.3,7.4,0]),'R' : np.array([28,7.4,26.3,40.3,7.4,0]),
                         'W' : np.array([28,7.4,26.3,40.3,7.4,0]),'A' : np.array([28,7.4,26.3,40.3,7.4,0]),
                         'V' : np.array([28,7.4,26.3,40.3,7.4,0]),'E' : np.array([28,7.4,26.3,40.3,7.4,0]),
                         'Y' : np.array([28,7.4,26.3,40.3,7.4,0]),'M' : np.array([28,7.4,26.3,40.3,7.4,0])
}
