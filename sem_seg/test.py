...
import os
import sys
from Protein_Data_Base import Protein_Utils
...
PDB_NAME = FLAGS.input_pdb_chain
...
def evaluate():
    ...
    out_data_label_filename = PDB_NAME + '_output_protein_pred.txt'
    out_data_label_filename = os.path.join(DUMP_DIR, out_data_label_filename)
    print(PDB_NAME, out_data_label_filename)
